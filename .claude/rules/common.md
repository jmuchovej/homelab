...
```nix
# Good: Use rebellion theme option
...
- Generic configs: `modules/common/programs/`
- NixOS overrides: `modules/nixos/programs/`
- macOS overrides: `modules/macos/programs/`

Example: Git config is in `common/programs/git/`, but macOS keychain integration
is in `macos/programs/git/`.
