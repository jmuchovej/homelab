...
argument-hint: "<module-path> [--type=home|nixos|macos] [--namespace] [--with-options] [--template=basic|advanced]"
...
```
IF rebellion project detected:
    Launch Task with Dotfiles Expert: "Provide rebellion module scaffolding patterns including namespace conventions, option organization, library usage, and template structures for [MODULE_TYPE] modules"
ELSE:
