# Taken from https://github.com/hmajid2301/nixicle/blob/d3bbe6/modules/home/cli/multiplexers/zellij/sesh.nix
...
if [[ $SESSION_EXISTS == "no" ]]; then
  # Available layouts
  LAYOUT=$(gum choose "default" "dev" "dev-simple" --header "Choose a layout for new session:")
